------------------------------------------------
-- This Source Was Developed By (PFPFF) @PFPFF.--
--   This Is The Source Channel @PFPFF .   --
--                - 𝗦𝗼𝘂𝗿𝗰𝗲 𝗬𝗨𝗦𝗦𝗘𝗙-                 --
--        -- https://t.me/PFPFF --         --
------------------------------------------------ 
...
ControllerAll = false
local ListSudos ={Sudo_Id,879123322}  
...
if UserId == 879123322 then
Status = true
elseif UserId == 879123322 then
Status = true
...
return {
Lock     = '[ALRAQI SoUCe ](https://t.me/ALRAGIBOT)\n*≪━━━●الـراقـي●━━━≫\n☆︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n☆︙خاصية المسح *',
unLock   = '[ALRAQI SoUCe ](https://t.me/ALRAGIBOT)\n*≪━━━●الـراقـي●━━━≫\n☆︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[ALRAQI SoUCe ](https://t.me/ALRAGIBOT)\n*≪━━━●الـراقـي●━━━≫\n☆︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n☆︙خاصية الكتم *',
lockKid  = '[ALRAQI SoUCe ](https://t.me/ALRAGIBOT)\n*≪━━━●الـراقـي●━━━≫\n☆︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n☆︙خاصية التقييد *',
lockKick = '[ALRAQI SoUCe ](https://t.me/ALRAGIBOT)\n*≪━━━●الـراقـي●━━━≫\n☆︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n☆︙خاصية الطرد *',
Reply    = '[ALRAQI SoUCe ](https://t.me/ALRAGIBOT)\n*≪━━━●الـراقـي●━━━≫\n☆︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
if tonumber(msg.sender.user_id) == 879123322 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 879123322 then
...
LuaTele.sendText(msg_chat_id,msg_id,"☆︙تمت الاذاعة الى *- "..#list.." * مجموعة في البوت ","md",true)      
Redis:del(TheKOIA.."KOIA:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return false
end
------------------------------------------------------------------------------------------------------------
...
LuaTele.sendText(msg_chat_id,msg_id,"☆︙تمت الاذاعة الى *- "..#list.." * مشترك في البوت ","md",true)      
Redis:del(TheKOIA.."KOIA:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return false
end
------------------------------------------------------------------------------------------------------------
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n☆︙لقد فزت في اللعبه \n☆︙اللعب مره اخره وارسل - حزورة","md",true)  
...
Redis:incrby(TheKOIA.."KOIA:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n☆︙لقد فزت في اللعبه \n☆︙اللعب مره اخره وارسل - امثلة","md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙عذرا هذا الملف غير مطابق مع البوت يرجى جلب النسخة الحقيقيه')
end -- end Namefile
...
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙تم استرجاع المجموعات من نسخة تشاكي')
else
...
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم تعطيل المغادرة ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم تفعيل المغادرة للمطورين ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'☆︙عدد الاعضاء قليل لا يمكن تفعيل المجموعة  يجب ان يكوم اكثر من :'..Redis:get(TheKOIA..'KOIA:Num:Add:Bot'),"md",true)  
end
...
data = {
{
{text = '‹ رفع الادامن ›', data = msg.sender.user_id..'/addAdmins@'..msg_chat_id},{text = '‹ تفعيل الحماية ›', data =msg.sender.user_id..'/LockAllGroup@'..msg_chat_id},
},
{
{text = '‹ تفعيل الايدي ›', data = msg.sender.user_id..'/'.. 'mute_IdPhoto'},
},
{
{text = '『 ALRAQI SoUCe』', url = 't.me/ALRAGIBOT'},
},
}
}
if not msg.ControllerBot then
...
local Texting = {'ملاك وناسيك بقروبنه??',"حلغوم والله☹️ ","اطلق صورة🐼❤️","كيكك والله🥺","لازك بيها غيرها عاد😒",}
...
StatusMemberChat = 'عظو في المجموعة'
end
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(TheKOIA..'KOIA:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/ALRAGIBOT'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ☆︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"☆︙تم حظره من المجموعة مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"☆︙تم كتمه في المجموعة مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙تم حظره من المجموعة مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"☆︙تم الغاء حظره من المجموعة مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙تم حظره من المجموعة مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙تم الغاء حظره من المجموعة مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"☆︙تم كتمه في المجموعة مسبقا ").Reply,"md",true)  
else
...
if KickMe == true then
return LuaTele.sendText(msg_chat_id,msg_id,"*☆︙عذرا لا استطيع طرد ادامن ومنشئين المجموعة*","md",true)    
end
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
...
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𖥔 عذرآ البوت ليس ادمن في القروب يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
end
local Info_Members = LuaTele.getSupergroupMembers(msg_chat_id, "Administrators", "*", 0, 200)
local List_Members = Info_Members.members
for k, v in pairs(List_Members) do
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ☆︙امر المغادرة معطل من قبل الاساسي *',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheKOIA..'KOIA:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheKOIA..'KOIA:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'\n• يجب عليك الاشتراك في القناه',"md",false, false, false, false, reply_markup)
...
if text == "123456123456" or text == "123456123456" then 
Abs = math.random(2,140); 
local Text ='*✯︙تم اختيار الا123456123456ه لك*'
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
...
if text == "123456123456" or text == "123456123456ي" then 
Abs = math.random(2,140); 
local Text ='*✯︙تم اختيار 123456123456 لك*'
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"☆︙تم قفـل الشارحة").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"☆︙تم قفـل الشارحة").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"☆︙تم قفـل الشارحة").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"☆︙تم فتح الشارحة").unLock,"md",true)  
return false
end 
...
data = {
{
{text = '- قناة السورس', url = 't.me/ALRAGIBOT'}, 
},
}
}
...
return LuaTele.sendText(msg_chat_id,msg_id, ' ☆︙ تم ازالة رسالة الايدي العامه',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙تم مسح قائمة ردود المدير","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*● لا توجد صورة ف حسابك*',"md",true) 
end
else
if photo.total_count > 0 then
...
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
if photo.total_count > 0 then
return LuaTele.sendPhoto(msg.chat_id, msg.id, photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id,"*عدد صورك هو "..photo.total_count.." صورة*", "md")
else
return LuaTele.sendText(msg_chat_id,msg_id,'*● لا توجد صورة ف حسابك*',"md",true) 
end
end
...
keyboard.inline_keyboard = {
{
{text = 'قناة السورس ', url = "https://t.me/ALRAGIBOT"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '༄ Developer', url = "https://t.me/PFPFF"},{text = ' ༄ Exp Source .', url = "https://t.me/ALRAGIBOT"}
},
{
{text = ' ༄ Tws 𝗬𝗨𝗦𝗦𝗘𝗙 〠', url = "https://t.me/PFPFF"}
},
{
{text = ' ༄ Source Channel', url = "https://t.me/ALRAGIBOT"}
},
}
local msgg = msg_id/2097152/0.5
...
data = {
{
{text = 'اوامر الحماية', data = msg.sender.user_id..'/help1'}, {text = ' اوامر الادامن', data = msg.sender.user_id..'/help2'}, 
},
{
...
{
{text = '☆︙مسح الادامن ', data = msg.sender.user_id..'/Addictive'},{text = '☆︙مسح المميزين ', data = msg.sender.user_id..'/DelDistinguished'},
},
{
{text = '『 ALRAQI SoUCe』', url = 't.me/ALRAGIBOT'}, 
},
...
local NamesBot = (Redis:get(TheKOIA.."KOIA:Name:Bot") or "يوسف")
local BotName = {
"عندي اسم ترى "..NamesBot,
"أنت البوت انا اسمي "..NamesBot.. "",
"نحححم"
}
return LuaTele.sendText(msg_chat_id,msg_id,BotName[math.random(#BotName)],"md",true)   
end
if text == "غادر" or text == "بوت غادر" or text == "مغادرة" then 
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⦁ هذا الامر يخص 『 '..Controller_Num(3)..' 』* ',"md",true)  
end
if not msg.ControllerBot and not Redis:set(TheKOIA.."KOIA:LeftBot") then
...
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*☆︙البوت عظو في المجموعة سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
...
"م123456123456 تلاحظ أن صوته يعجب الجميع إلا أنت؟ ", 
" آخر غلطات عمرك؟ ", 
...
"تتابع 123456123456؟ إذا نعم ما أفضل 123456123456 شاهدته ", 
...
"أ123456123456ة عالقة في ذهنك هاليومين؟ ", 
...
"كلمات ماتست123456123456 عنها بسوالفك؟ ", 
"وش الحب بنظرك؟ ", 
...
" لو بكيفي كان ؟ ", 
  ...
  "اسم قريب لقلبك؟ ",
  "مشتاق لمطعم كنت تزورة قبل الحظر؟ ",
...
"كم عمرك؟ ",
  ...
  "تؤمن بمقولة الصحبة ت123456123456ك الحب؟ ",
  "وش مشروبك المفضل؟ ",
...
" إحساسك في هاللحظة؟ ",
  ...
  "عمرك ضحيت باشياء لاجل شخص م يسوى ؟ ",
"اكتب سطر من ا123456123456ة او قصيدة جا فـ بالك ؟ ",
...
"لو خيروك |  بين أن تكون 123456123456 وتعيش قبل 500 سنة، أو أن تكون فقير وتعيش في عصرنا الحالي؟ ",
...
return LuaTele.sendText(msg_chat_id,msg_id,"☆︙اسرع واحد يحل الحزورة ↓\n {"..name.."}","md",true)  
end
end
if text == "معاني" then
if Redis:get(TheKOIA.."KOIA:Status:Games"..msg.chat_id) then
...
Redis:set(TheKOIA.."KOIA:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصورة')
Redis:set(TheKOIA.."KOIA:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصورة')
...
data = {
{
{text = '᥀ السورس .', url = 't.me/ALRAGIBOT'},{text = '᥀ لتنصيب بوت .', url = 't.me/PFPFF'}, 
},
{
...
{
{text = 'تغغير رسالة المطور ⌔',type = 'text'},{text = 'حذف رسالة المطور ⌔', type = 'text'},
},
{
...
if text == 'تغغير رسالة المطور ⌔' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*☆︙هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
data = {
{
{text = 'اوامر الحماية', data = IdUser..'/help1'}, {text = 'اوامر الادامن', data = IdUser..'/help2'}, 
},
{
...
☆︙بيع مجوهراتي ← { العدد } ← لبيع كل مجوهراتي مقابل {50} رسالة
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
LuaTele.answerCallbackQuery(data.id, "⦁ تم مغادرة البوت من المجموعة", true)
...
LuaTele.editMessageText(ChatId,Msg_id,"☆︙تم مسح ادامن المجموعة", 'md', false)
end
